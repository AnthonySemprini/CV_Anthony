...
function App() {
  return (
    ...
    <div className='  w-1/4 h-[100vh] flex justify-center bg-sky-500 m-3 p-5 rounded-lg'><Header /></div>
    <div className=' w-3/4 h-[100vh] bg-sky-500 m-3 p-5 rounded-lg'><Profil /></div>
